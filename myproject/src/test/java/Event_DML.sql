...
INSERT INTO EVT_EVT (EVT_NM, ST_DATE, END_DATE, EVT_ST, EVT_FILE_URL, EVT_CTG_ID, EVT_TRG, EVT_PHONE, EVT_TRG_DATE)
VALUES('Seezn, 5월엔 5만명 선물 이벤트', '2020-05-08','2020-05-31',  1, 'https://event.kt.com/images/11460/banner02.jpg', 0, 'Seezn 로그인 고객 누구나', '02-569-5422', '9999-12-31');
INSERT INTO EVT_EVT (EVT_NM, ST_DATE, END_DATE, EVT_ST, EVT_FILE_URL, EVT_CTG_ID, EVT_TRG, EVT_PHONE, EVT_TRG_DATE)
...
-- 1번 시즌 상세 데이터
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE)
...
-- 6번 키즈랜드 페스티벌!
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE) VALUES (6, 'https://benefit.kt.com/event/otv/kfair/img/img_visual.jpg', 'IMG');
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE) VALUES (6, 'https://benefit.kt.com/event/otv/kfair/img/img_event_01.jpg', 'IMG');
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE) VALUES (6, 'https://benefit.kt.com/event/otv/kfair/img/img_event_02.jpg', 'IMG');
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE) VALUES (6, 'https://benefit.kt.com/event/otv/kfair/img/btn_land.png', 'BTN');
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE) VALUES (6, 'https://benefit.kt.com/event/otv/kfair/img/img_event_03.jpg', 'IMG');
INSERT INTO EVT_DT (EVT_IDX, RES_DATA, DATA_TYPE) VALUES (6, 'https://benefit.kt.com/event/otv/kfair/img/img_attention.jpg', 'INFO');
